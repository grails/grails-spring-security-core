...
class PBKDF2PasswordEncoder implements org.springframework.security.authentication.encoding.PasswordEncoder {
	...
	String encodePassword(String rawPass, saltIgnored) {
	...
	boolean isPasswordValid(String encPass, String rawPass, saltIgnored) {
		char[] password = rawPass.toCharArray()
