...
class SpringSecurityCoreGrailsPlugin extends Plugin {
    ...
    Closure doWithSpring() { {->
            ...
            // println "This is the spring security core plugin in action"
            def responseMimeTypesApi = new HttpServletResponseExtension()
...
"""
    ...
    void doWithDynamicMethods(ctx) {//{ ctx ->
    ...
    void doWithApplicationContext(ctx) {//{ctx ->
